 ...
 *
 */
class Jamersan_Productwarranty_Block_Adminhtml_Productwarranty_View extends Mage_Adminhtml_Block_Widget_Container
{

    /**
     * Jamersan_Productwarranty_Block_Adminhtml_Productwarranty_View constructor.
     */
