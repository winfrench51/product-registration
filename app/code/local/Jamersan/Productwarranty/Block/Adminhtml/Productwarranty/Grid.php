 ...
 *
 */
class Jamersan_Productwarranty_Block_Adminhtml_Productwarranty_Grid extends Mage_Adminhtml_Block_Widget_Grid
{

    /**
     * Jamersan_Productwarranty_Block_Adminhtml_Productwarranty_Grid constructor.
     */
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->join(
            array('prod' => Mage::getSingleton('core/resource')->getTableName(Mage::getConfig()->getTablePrefix() . 'productwarranty_products')),
